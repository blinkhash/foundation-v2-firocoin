...
describe('Test pool functionality', () => {
  ...
  test('Test pool block polling setup [2]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      ...
      if (response.length === 3) {
        ...
        expect(response[2][1]).toBe('Requested template from primary chain (Firocoin:1) via RPC polling');
        done();
      }
    });
    mockSetupDaemons(pool, () => {
  ...
  test('Test pool workers handling [1]', () => {
    ...
    const blocks1 = {
      ...
      miner: 'aKoefNw7AeYKosEYwjCi4RQpVhBWRwU5Mj',
      worker: 'aKoefNw7AeYKosEYwjCi4RQpVhBWRwU5Mj.worker1',
      category: 'immature',
      confirmations: 3,
    ...
    const worker1 = {
      ...
      miner: 'aKoefNw7AeYKosEYwjCi4RQpVhBWRwU5Mj',
      worker: 'aKoefNw7AeYKosEYwjCi4RQpVhBWRwU5Mj.worker4',
      identifier: 'master',
      invalid: 0,
      round: '15c8343c-9751-4c67-aafa-29ff296da484',
      solo: false,
    ...
    const expected = { 'aKoefNw7AeYKosEYwjCi4RQpVhBWRwU5Mj': { 'immature': 9999.996, 'generate': 0 }};
  ...
  test('Test pool workers handling [2]', () => {
    ...
    const expected = { 'aKoefNw7AeYKosEYwjCi4RQpVhBWRwU5Mj': { 'generate': 0, 'immature': 19999.992 }};
  ...
  test('Test pool workers handling [3]', () => {
    ...
    const expected = {
      'aKoefNw7AeYKosEYwjCi4RQpVhBWRwU5Mj': { 'immature': 4999.998, 'generate': 0 },
  ...
  test('Test pool workers handling [4]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'aKoefNw7AeYKosEYwjCi4RQpVhBWRwU5Mj': { 'immature': 8474.10655446, 'generate': 0 },
  ...
  test('Test pool workers handling [5]', () => {
    ...
    const expected = { 'aKoefNw7AeYKosEYwjCi4RQpVhBWRwU5Mj': { 'generate': 9999.996, 'immature': 0 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [6]', () => {
    ...
    const expected = { 'aKoefNw7AeYKosEYwjCi4RQpVhBWRwU5Mj': { 'immature': 0, 'generate': 19999.992 }};
    pool.handlePrimaryWorkers([blocks1, blocks1], [[worker1], [worker1]], (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
