...
describe('Test pool functionality', () => {
  ...
  test('Test pool manager setup [9]', (done) => {
    ...
    pool.on('pool.log', (type, text) => {
      if (type !== 'debug') {
        ...
        expect(text).toBe('Submitted a primary block (Firocoin:1) successfully to Firocoin\'s daemon instance(s)');
        done();
      }
    });
    mockSetupDaemons(pool, () => {
  ...
  test('Test pool workers handling [9]', () => {
    ...
    const expected = { 'aKoefNw7AeYKosEYwjCi4RQpVhBWRwU5Mj': { 'immature': 0, 'generate': -10000 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], false, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
  ...
  test('Test pool workers handling [12]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'aKoefNw7AeYKosEYwjCi4RQpVhBWRwU5Mj': { 'immature': 9570.00569668, 'generate': 0 },
      'aKoefNw7AeYKosEYwjCi4RQpVhBWRwU5Mk': { 'immature': 429.99430332, 'generate': 0 }};
  ...
  test('Test pool workers handling [14]', () => {
    ...
    const expected = { 'aKoefNw7AeYKosEYwjCi4RQpVhBWRwU5Mj': { 'immature': -10000, 'generate': 10000 }};
    pool.handlePrimaryWorkers([blocks1], [[worker1]], true, (results) => {
      expect(results).toStrictEqual(expected);
    });
  });
